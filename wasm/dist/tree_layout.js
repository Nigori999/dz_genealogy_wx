  ...
  return (
    async function (moduleArg = {}) {
      ...
      function findWasmBinary() {
        if (Module["locateFile"]) {
          return locateFile("tree_layout.wasm")
        }
        return new URL("tree_layout.wasm",
      ...
      var wasmImports = {
        g: ___cxa_throw,
        p: __abort_js,
        h: __embind_finalize_value_array,
      ...
      var ___getTypeName = wasmExports["z"];
...
export default TreeLayoutModule;