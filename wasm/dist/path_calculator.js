  ...
  return (
    async function (moduleArg = {}) {
      ...
      function findWasmBinary() {
        if (Module["locateFile"]) {
          return locateFile("path_calculator.wasm")
        }
        return new URL("path_calculator.wasm",
      ...
      var wasmImports = {
        ...
        u: __embind_register_value_array,
        t: __embind_register_value_array_element,
      ...
      var ___getTypeName = wasmExports["y"];
      var _malloc = wasmExports["z"];
      var _free = wasmExports["A"];
