...
mockData.genealogies.push({
  id: 'gen_003',
  name: '赵氏家族树',
  description: '这是一个用于测试Canvas树图功能的赵氏族谱数据',
...
const testMembers = [
  // 第一代 - 始祖夫妇
  {
    ...
    gender: 'male',
    avatar: '/assets/images/avatar_default.png',
    birthDate: '1890-02-15',
    deathDate: '1975-10-08',
    birthPlace: '山东济南',
    rank: '始祖',
    generation: 1,
    occupation: '商人',
    biography: '赵氏家族第一代族长，在济南经营布匹生意有成',
    relationToCurrentUser: '曾祖父',
    parentId: null,
    spouseIds: ['test_002'],
  ...
  },
  {
    ...
    gender: 'female',
    avatar: '/images/avatar_female_default.png',
    birthDate: '1895-05-20',
    deathDate: '1978-03-15',
    birthPlace: '山东青岛',
    rank: '始祖妻',
    generation: 1,
    occupation: '家庭主妇',
    biography: '赵氏家族第一代族长夫人，贤良淑德',
    relationToCurrentUser: '曾祖母',
    parentId: null,
    spouseIds: ['test_001'],
    childrenIds: ['test_003', 'test_004', 'test_005'],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  // 第二代 - 三个子女
  {
    ...
    generation: 2,
    occupation: '医生',
    biography: '赵德胜长子，抗战时期曾任军医，后在济南开设诊所',
    relationToCurrentUser: '祖父',
    parentId: 'test_001',
    spouseIds: ['test_006'],
  ...
  },
  {
    ...
    gender: 'male',
    avatar: '/assets/images/avatar_default.png',
    birthDate: '1923-05-15',
    deathDate: '1995-06-20',
    birthPlace: '山东济南',
    rank: '次子',
    generation: 2,
    occupation: '教师',
    biography: '赵德胜次子，曾任中学校长，桃李满天下',
    relationToCurrentUser: '大爷',
    parentId: 'test_001',
    spouseIds: ['test_009'],
  ...
  },
  {
    ...
    generation: 2,
    occupation: '会计',
    biography: '赵德胜长女，曾在国营企业担任财务主管',
    relationToCurrentUser: '姑奶奶',
    parentId: 'test_001',
    spouseIds: ['test_013'],
  ...
  // 第二代配偶
  {
    ...
    gender: 'female',
    avatar: '/images/avatar_female_default.png',
    birthDate: '1922-03-18',
    deathDate: '1992-11-05',
    birthPlace: '河北石家庄',
    rank: '长媳',
    generation: 2,
    occupation: '护士',
    biography: '赵建国妻子，曾在丈夫诊所担任护士长',
    relationToCurrentUser: '祖母',
    parentId: null,
    spouseIds: ['test_003'],
    childrenIds: ['test_007', 'test_008'],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  },
  {
    ...
    gender: 'female',
    avatar: '/images/avatar_female_default.png',
    birthDate: '1925-11-10',
    deathDate: '1998-07-25',
    birthPlace: '山东青岛',
    rank: '次媳',
    generation: 2,
    occupation: '教师',
    biography: '赵建军妻子，也是一名教师，教授语文',
    relationToCurrentUser: '大娘',
    parentId: null,
    spouseIds: ['test_004'],
    childrenIds: ['test_010', 'test_011', 'test_012'],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  },
  {
    ...
    deathDate: '2000-01-30',
    birthPlace: '江苏南京',
    rank: '女婿',
    generation: 2,
    occupation: '工程师',
    biography: '赵秀英丈夫，桥梁工程师，参与多座著名桥梁建设',
    relationToCurrentUser: '姑爷',
    parentId: null,
    spouseIds: ['test_005'],
    childrenIds: ['test_014'],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  // 第三代 - 长子的子女
  {
    ...
    generation: 3,
    occupation: '医学教授',
    biography: '赵建国长子，医学博士，现任医科大学教授',
    relationToCurrentUser: '父亲',
    parentId: 'test_003',
    spouseIds: ['test_015'],
  ...
  },
  {
    ...
    generation: 3,
    occupation: '艺术家',
    biography: '赵建国长女，知名水墨画家',
    relationToCurrentUser: '姑姑',
    parentId: 'test_003',
    spouseIds: [],
    childrenIds: [],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  // 第三代 - 次子的子女
  {
    ...
    generation: 3,
    occupation: '企业家',
    biography: '赵建军长子，创办科技公司，事业有成',
    relationToCurrentUser: '堂叔',
    parentId: 'test_004',
    spouseIds: ['test_022'],
    childrenIds: ['test_023', 'test_024'],
    createdAt: '2023-05-01T08:00:00Z',
    updatedAt: '2023-05-01T08:00:00Z'
  },
  {
  ...
  },
  {
    ...
    generation: 3,
    occupation: '教师',
    biography: '赵建军长女，大学英语教师',
    relationToCurrentUser: '堂姑',
    parentId: 'test_004',
    spouseIds: [],
    childrenIds: [],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  // 第三代 - 长女的子女
  {
    ...
    generation: 3,
    occupation: '建筑师',
    biography: '赵秀英之子，著名建筑设计师',
    relationToCurrentUser: '表叔',
    parentId: 'test_005',
    spouseIds: ['test_020'],
  ...
  // 第三代配偶
  {
    ...
    generation: 3,
    occupation: '药剂师',
    biography: '赵明妻子，医院药剂师',
    relationToCurrentUser: '母亲',
    parentId: null,
    spouseIds: ['test_007'],
    childrenIds: ['test_016', 'test_017'],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  },
  {
    ...
    generation: 3,
    occupation: '会计师',
    biography: '赵勇妻子，注册会计师',
    relationToCurrentUser: '堂婶',
    parentId: null,
    spouseIds: ['test_011'],
    childrenIds: ['test_019'],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  },
  {
    ...
    generation: 3,
    occupation: '室内设计师',
    biography: '陈志远妻子，知名室内设计师',
    relationToCurrentUser: '表婶',
    parentId: null,
    spouseIds: ['test_014'],
    childrenIds: ['test_021'],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  // 第四代 - 当前用户所在代
  {
    ...
    generation: 4,
    occupation: '软件工程师',
    biography: '赵明长子，知名科技公司首席工程师',
    relationToCurrentUser: '自己',
    parentId: 'test_007',
    spouseIds: ['test_025'],
    childrenIds: ['test_026', 'test_027'],
    createdAt: '2023-05-01T08:00:00Z',
    updatedAt: '2023-05-01T08:00:00Z'
  },
  {
    ...
    generation: 4,
    occupation: '医生',
    biography: '赵明长女，继承父业成为医生',
    relationToCurrentUser: '妹妹',
    parentId: 'test_007',
    spouseIds: [],
    childrenIds: [],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  },
  {
    ...
    generation: 4,
    occupation: '法律顾问',
    biography: '赵勇之子，企业法律顾问',
    relationToCurrentUser: '堂弟',
    parentId: 'test_011',
    spouseIds: [],
    childrenIds: [],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  },
  {
    ...
    generation: 4,
    occupation: '景观设计师',
    biography: '陈志远之女，著名景观设计师',
    relationToCurrentUser: '表妹',
    parentId: 'test_014',
    spouseIds: [],
    childrenIds: [],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  },
  {
    ...
    generation: 4,
    occupation: '市场总监',
    biography: '赵强长子，跨国公司市场总监',
    relationToCurrentUser: '堂兄',
    parentId: 'test_010',
    spouseIds: [],
    childrenIds: [],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  },
  {
    ...
    generation: 4,
    occupation: '人力资源总监',
    biography: '赵强长女，人力资源专家',
    relationToCurrentUser: '堂姐',
    parentId: 'test_010',
    spouseIds: [],
    childrenIds: [],
    createdAt: '2023-05-01T08:00:00Z',
  ...
  // 第四代配偶
  {
    ...
    generation: 4,
    occupation: '产品经理',
    biography: '赵伟妻子，科技公司产品经理',
    relationToCurrentUser: '妻子',
    parentId: null,
    spouseIds: ['test_016'],
    childrenIds: ['test_026', 'test_027'],
    createdAt: '2023-05-01T08:00:00Z',
